      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
              ...
              <li>
                ...
                <ul class="menu">
                  <li><!-- start message -->
                    <a href="#">
                      <div class="pull-left">
                        <img src="{{asset('upload/1.jpg')}}" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                        Support Team
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="{{asset('upload/1.jpg')}}" class="user-image" alt="User Image">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          <a href="#">
            <i class="fa fa-dashboard"></i> <span>{{trans('message.Dashboard')}}</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            @if(Gate::allows('product_list',Auth::user()))
            <li class="active"><a href="{{route('product')}}"><i class="fa fa-circle-o"></i> {{trans('message.Product')}}</a></li>
            @endif
            @if(Gate::allows('permission_list',Auth::user()))
            <li><a href="{{route('permission_list')}}"><i class="fa fa-circle-o"></i>{{trans('message.Permission')}}</a></li>
            @endif
            @if(Gate::allows('role_list',Auth::user()))
            <li><a href="{{route('role_list')}}"><i class="fa fa-circle-o"></i>{{trans('message.Role')}}</a></li>
            @endif
            @if(Gate::allows('user_list',Auth::user()))
            <li><a href="{{route('user_list')}}"><i class="fa fa-circle-o"></i>{{trans('message.User')}}</a></li>
            @endif
            @if(Gate::allows('country',Auth::user()))
             <li><a href="{{route('country')}}"><i class="fa fa-circle-o"></i>{{trans('message.Country')}}</a></li>
             @endif
             @if(Gate::allows('content',Auth::user()))
             <li><a href="{{route('content')}}"><i class="fa fa-circle-o"></i>{{trans('message.Content')}}</a></li>
             @endif
